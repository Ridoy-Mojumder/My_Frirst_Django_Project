...
class Custom_User(AbstractUser):
    USER=[
        ('recruiter','Recruiter'),('jobseeker','JobSeeker'),('generaluser','GeneralUser'),('stuff','Stuff')
    ]
...
class stuff_Profile(models.Model):
    user=models.OneToOneField(Custom_User, on_delete=models.CASCADE,null=True, related_name='stuffprofile')

    def __str__(self):
        return self.user.display_name


class Generaluser_Profile(models.Model):
    user=models.OneToOneField(Custom_User, on_delete=models.CASCADE,null=True, related_name='generaluserprofile')
